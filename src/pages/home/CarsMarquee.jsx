                    ...
                    tags.map((tag, idx) => {
                        return (
                            <div key={idx} className="flex items-center justify-center">
                                <span className="mx-6 text-[64px] title-font font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#5ad830] to-[#5fa747]">{tag}</span>
                                <span className="text-[#78CA5C] text-[30px]">●</span>
                            </div>
                        )
                    })
                }
